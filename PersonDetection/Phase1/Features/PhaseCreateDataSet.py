"""
Created by Bing Liu
Create dataset used to train phase CNN model
"""
...
def CreateDataSet_Column(Raw_file_list, Reqs_Num):
    ...
    for raw_file in Raw_file_list:
        ...
        i = 0
        phase_pack = np.zeros((len(Raw_arr), IQ_Num, 1)).astype(hd.IQ_Data_Type_Str)
        ...
        Phase_All.append(phase_pack)

    return Lables, Phase_All
