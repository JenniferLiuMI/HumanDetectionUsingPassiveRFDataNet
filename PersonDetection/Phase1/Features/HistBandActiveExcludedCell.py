"""
Created by Bing Liu
Human detection using histogram of active bands excluding cell bands data
"""
...
Data_Set_Path = hd.Hist_Model_Path_Active_Band_ExcludedCell
Model_Path = hd.Hist_Data_Set_Path_Active_Band_ExcludedCell
