"""
Created by Bing Liu
Human detection using amplitude of selected bands data collected at office
"""
...
Data_Set_Path = hd.AMP_Data_Set_Path_Selective_Band_Office
Model_Path = hd.AMP_Model_Path_Selective_Band_Office
