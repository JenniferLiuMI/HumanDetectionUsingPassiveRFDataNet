"""
Created by Bing Liu
Human detection using histogram of random bands data collected at office
"""
...
Data_Set_Path = hd.Hist_Model_Path_Random_Band_Offce
Model_Path = hd.Hist_Data_Set_Path_Random_Band_Offce
