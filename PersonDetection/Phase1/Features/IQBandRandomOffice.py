"""
Created by Bing Liu
Human detection using IQ of random bands collected at office
"""
...
Data_Set_Path = hd.IQ_Data_Set_Path_Random_Band_Office
Model_Path = hd.IQ_Model_Path_Random_Band_Office
