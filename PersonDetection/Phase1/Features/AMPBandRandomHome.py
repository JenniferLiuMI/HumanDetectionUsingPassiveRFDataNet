"""
Created by Bing Liu
Human detection using amplitude of random bands data collected at home
"""
...
Data_Set_Path = hd.AMP_Data_Set_Path_Random_Band_Home
Model_Path = hd.AMP_Model_Path_Random_Band_Home
