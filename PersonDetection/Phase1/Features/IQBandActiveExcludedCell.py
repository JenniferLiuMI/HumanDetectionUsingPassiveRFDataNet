"""
Created by Bing Liu
Human detection using IQ of active bands excluding cell bands data
"""
...
Data_Set_Path = hd.IQ_Data_Set_Path_Active_Band_ExcludedCell
Model_Path = hd.IQ_Model_Path_Active_Band_ExcludedCell
