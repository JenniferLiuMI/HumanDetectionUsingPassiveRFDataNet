"""
Created by Bing Liu
Human detection using amplitude of active bands data
"""
...
IQ_Data_File_Path = hd.IQ_Data_File_Path_Active_Band
Data_Set_Path = hd.AMP_Data_Set_Path_Active_Band
Model_Path = hd.AMP_Model_Path_Active_Band
